...
from menu_manager import is_admin, add_to_context_menu, remove_from_context_menu
from context_menu_manager import Ui_MenuManager


class ContextMenuManager(QMainWindow):
    def __init__(self):
        super().__init__()
        self.ui = Ui_MenuManager()
    ...
    def init_ui(self):
        self.ui.add_button.clicked.connect(add_to_context_menu)
        self.ui.remove_button.clicked.connect(remove_from_context_menu)
